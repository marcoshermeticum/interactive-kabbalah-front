...
export const qliphothPaths: QliphothPathDef[] = [
  ...
  { from: 'ghogiel', to: 'ghagsheblah', number: 16, letter: 'ו', letterName: 'Vav', sign: '♉', tunnel: "Uriens", meaning: 'Adimiron (Touro)', color: '#4d3300', virtue: 'Persistência profunda', vice: 'Teimosia mortal' },
