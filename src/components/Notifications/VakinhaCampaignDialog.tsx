    ...
    <div className="fixed inset-0 z-[900] flex items-center justify-center">
      ...
      >
        ...
        <button
          ref={closeButtonRef}
          onClick={handleDismiss}
          className="absolute top-4 right-4 w-8 h-8 rounded-full flex items-center justify-center bg-white/5 text-white/40 hover:bg-white/10 hover:text-white/80 transition-all cursor-pointer"
          aria-label={ui('close')}
        >
        ...
        <h2
          ...
          className="text-center text-[22px] font-semibold text-white/95 mb-2 leading-tight"
          style={{
        ...
        {/* Subtitle */}
        <p className="text-center text-xs font-medium text-amber-500/70 uppercase tracking-[2px] mb-5">
          {t('subtitle')}
        </p>

        {/* Message */}
        <p className="text-center text-sm text-white/65 leading-relaxed mb-8 px-2">
          {t('message')}
        </p>
        ...
        <a
          ...
          className="block w-full py-3.5 px-5 rounded-xl text-center text-white text-[15px] font-semibold no-underline cursor-pointer transition-all mb-7 hover:-translate-y-px"
          style={{
        ...
        {/* PIX Section */}
        <div className="rounded-xl p-4 mb-6" style={{ background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.08)' }}>
          <p className="text-[11px] text-white/40 uppercase tracking-[1px] mb-2 text-center">
            {t('pixLabel')}
          </p>
